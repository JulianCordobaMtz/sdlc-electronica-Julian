...
| RF-2 | Parcial | POST existe; la validación física solo cubre temperatura | P0 |
| RF-3 | Casi listo | Paginación y fechas existen; faltan casos borde de integración | P0 |
| RF-4 | Parcial | Alerta por umbral superior existe; falta definir severidad y otros tipos | P0 |
...
| RNF-4 | Bloqueado | Docker/Compose existen, pero no hay ninguna revisión Alembic | P0 |
...
- [ ] Completar validación física por tipo de sensor en dominio puro.
- [ ] Rechazar lecturas para sensores inexistentes o inactivos.
...
- [ ] Crear migración Alembic inicial y eliminar `create_all` del arranque.
